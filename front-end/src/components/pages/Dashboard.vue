                        ...
                        <div class="white-box">
                            <div class="media bg-primary">
                                <div class="media-body">
                                    <h3 class="info-count">154 <span class="pull-right"><i
                    ...
                    <div class="col-md-3 col-sm-6 info-color-box">
                        <div class="white-box">
                            <div class="media bg-success">
                                <div class="media-body">
                                    <h3 class="info-count">68 <span class="pull-right"><i
                                                class="mdi mdi-comment-text-outline"></i></span></h3>
                                    <p class="info-text font-12">Complaints</p>
                                    <p class="info-ot font-15">Total Pending<span class="label label-rounded">154</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 info-color-box">
                        <div class="white-box">
                            <div class="media bg-danger">
                                <div class="media-body">
                                    <h3 class="info-count">&#36;9475 <span class="pull-right"><i
                    ...
                    <div class="col-md-3 col-sm-6 info-color-box">
                        <div class="white-box">
                            <div class="media bg-warning">
                                <div class="media-body">
                                    <h3 class="info-count">&#36;124,356 <span class="pull-right"><i
                                                class="mdi mdi-coin"></i></span></h3>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0);" class="text-link">Sergio Milardovich</a>
                                            </td>
                            ...
                            <ul class="media-list">
                                <li class="media">
                                    <div class="media-left">
                                        <a href="#"> <img alt="user" class="media-object"
                                                v-bind:src="'../plugins/images/users/jeffery.jpg'"> </a>
                                    </div>
                                    <div class="media-body">
                                        <div class="media-heading"><a href="javascript:void(0);" class="text-link">
                                                Daniel Kristeen</a><span class="font-normal com-time">2 min ago</span>
                                            <ul class="list-inline">
                                                <li>
                                                    <a href="javascript:void(0);"><span>Reply</span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><i class="fa fa-heart p-r-5"></i>0
                                                        Like</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="media reply">
                                            <div class="media-left">
                                                <a href="#"> <img alt="user" class="media-object"
                                                        v-bind:src="'../plugins/images/users/hanna.jpg'"> </a>
                                            </div>
                                            <div class="media-body">
                                                <div class="media-heading"><a href="javascript:void(0);"
                                                        class="text-link">Hanna Gover</a><span
                                                        class="font-normal com-time">1 min ago</span>
                                                    <ul class="list-inline">
                                                        <li>
                                                            <a href="javascript:void(0);"><span>Reply</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:void(0);"><i
                                                                    class="fa fa-heart p-r-5"></i>0 Like</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="media-heading"><a href="javascript:void(0);" class="text-link">
                                                Daniel Kristeen</a><span class="font-normal com-time">2 sec ago</span>
                                            <ul class="list-inline">
                                                <li>
                                                    <a href="javascript:void(0);"><span>Reply</span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><i
                                                            class="fa fa-heart p-r-5 text-danger"></i>2 Like</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                        ...
                        <div class="white-box">
                            <div class="profile-widget">
                                <div class="profile-img">
                                    <img v-bind:src="'../plugins/images/users/jeffery.jpg'" alt="user-img" class="img-circle">
                                    <p class="m-t-10 m-b-5"><a href="javascript:void(0);"
                                            class="profile-text font-22 font-semibold">Jeffery Brown</a></p>
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img v-bind:src="'../plugins/images/users/1.jpg'" alt="user-img"
                                            class="img-circle"> <span>Varun Dhavan <small
                                                class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img v-bind:src="'../plugins/images/users/2.jpg'" alt="user-img"
                                            class="img-circle"> <span>Genelia Deshmukh <small
                                                class="text-warning">Away</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img v-bind:src="'../plugins/images/users/3.jpg'" alt="user-img"
                                            class="img-circle"> <span>Ritesh Deshmukh <small
                                                class="text-danger">Busy</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img v-bind:src="'../plugins/images/users/4.jpg'" alt="user-img"
                                            class="img-circle"> <span>Arijit Sinh <small
                                                class="text-muted">Offline</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img v-bind:src="'../plugins/images/users/5.jpg'" alt="user-img"
                                            class="img-circle"> <span>Govinda Star <small
                                                class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img v-bind:src="'../plugins/images/users/6.jpg'" alt="user-img"
